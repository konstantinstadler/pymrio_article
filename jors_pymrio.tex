...
\begin{description}[noitemsep,topsep=0pt]
    ...
    \item[Version published:] 0.4.5 and earlier versions. The DOI above always resolves to the latest version, previous versions can be identified with separate DOIs (see versions sections on the Zenodo repository page). 
    \item[Date published:] 21/03/21 (version 0.4.5)
\end{description}
