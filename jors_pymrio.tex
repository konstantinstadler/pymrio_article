...
For development and unit testing the pytest module and black code formater are required. The requirments_test.txt file and alternatively the environment_dev.yml file (for using conda environments) outline all dependencies necessary for testing and development.
